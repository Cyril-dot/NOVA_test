...
@Table(
        ...
        indexes = {
                @Index(name = "idx_project_docs_project_id", columnList = "project_id"),
                @Index(name = "idx_project_docs_type", columnList = "document_type"),
                @Index(name = "idx_project_docs_created_at", columnList = "created_at")
        }
)
@Data
@AllArgsConstructor
